    ...
    return (
      ...
      >
        ...
        <Branch
          ...
          warning
          onUpdate={(value) => { this.updateField('HasForeignTravelOutside', value) }}
        ...
        <Show when={(this.props.HasForeignTravelOutside || {}).value === 'Yes'}>
          <Branch
            ...
            onUpdate={(value) => { this.updateField('HasForeignTravelOfficial', value) }}
            required={this.props.required}
            onError={this.handleError}
            scrollIntoView={this.props.scrollIntoView}
          >
        ...
        >
          <Accordion
            ...
            onUpdate={(value) => { this.updateField('List', value) }}
            onError={this.handleError}
