...
import identificationContacts from '../identificationContacts'
...
describe('The identificationContacts model', () => {
  it('requires at least one phone number', () => {
    ...
    expect(validateModel(testData, identificationContacts))
  ...
  it('does not require both email addresses', () => {
    ...
    expect(validateModel(testData, identificationContacts)).toEqual(true)
  })
